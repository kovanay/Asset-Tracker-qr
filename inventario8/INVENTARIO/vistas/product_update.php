        ...
        <form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
            ...
            <div class="columns">
                ...
                <div class="column">
                    <div class="control">
                        <label>Stock</label>
                        <input class="input" type="text" name="producto_stock" maxlength="25" required value="<?php echo $datos['producto_stock']; ?>" >
                    </div>
                </div>
                <div class="column">
                    <label>Tipo</label><br>
                    <div class="select is-rounded">
                        <select name="producto_unidad">
                            <option value="Metros" <?php if ($datos['producto_unidad'] == 'Metros') echo 'selected'; ?>>Metros</option>
                            <option value="Cantidad" <?php if ($datos['producto_unidad'] == 'Cantidad') echo 'selected'; ?>>Cantidad</option>
                            <option value="Kilos" <?php if ($datos['producto_unidad'] == 'Kilos') echo 'selected'; ?>>Kilos</option>
                            <option value="Litros" <?php if ($datos['producto_unidad'] == 'Litros') echo 'selected'; ?>>Litros</option>
                            <option value="Cubeta(s)" <?php if ($datos['producto_unidad'] == 'Cubeta(s)') echo 'selected'; ?>>Cubeta(s)</option>
                        </select>
                    </div>
                </div>
                <div class="column">
                ...
                <div class="column">
                    ...
                    <div class="select is-rounded">
                        <select name="producto_tipo">
                            <option value="no_consumible" <?php if ($datos['tipo'] == 'no_consumible') echo 'selected'; ?>>No Consumible</option>
                            <option value="consumible" <?php if ($datos['tipo'] == 'consumible') echo 'selected'; ?>>Consumible</option>
                        </select>
                    </div>
                </div>
            </div>
